...
function generate() {
    nom_rep = capitalizarPrimeraLetra(document.getElementById("nom_rep").value)
    cargo = document.getElementById("cargo").value
    org = document.getElementById("org").value
    ant = capitalizarPrimeraLetra(document.getElementById("ant").value)
    ...
    nom_rep_op = document.getElementById("nom_rep_op").value.toUpperCase()
    nom_rep_m = document.getElementById("nom_rep").value.toUpperCase()
    cargo_m = document.getElementById("cargo").value.toUpperCase()
